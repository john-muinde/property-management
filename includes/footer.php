         ...
         <div class="row">
            <div class=" col-md-4">
               ...
               <ul class="conta">
                  ...
                  <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@lakesideresorts.co.ke">
                        info@lakesideresorts.co.ke</a></li>
               </ul>
            </div>
            <div class="col-md-4">
               <h3>Quick Links</h3>
               <ul class="link_menu">
                  ...
                  <li class="<?php echo ($current_page == 'rooms.php') ? 'active' : ''; ?>"><a
                        href="rooms.php">Accommodations</a></li>
                  <li class="<?php echo ($current_page == 'spa_services.php') ? 'active' : ''; ?>"><a
                        href="spa_services.php">Spa Services</a></li>
                  <li class="<?php echo ($current_page == 'gallery.php') ? 'active' : ''; ?>"><a
