...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        mysqli_stmt_bind_param($stmt, "sssissii", $name, $description, $price, $capacity, $image_name, $amenities, $is_available, $room_id);
...
<head>
    ...
    <title>Edit Room - Lakeside Resorts</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="room_edit.php?id=<?php echo $room_id; ?>" method="post" enctype="multipart/form-data">
