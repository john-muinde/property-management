...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO spa_services (name, description, price, duration, image, is_available) 
                VALUES (?, ?, ?, ?, ?, ?)";

        $stmt = mysqli_prepare($conn, $sql);
        mysqli_stmt_bind_param($stmt, "ssdisi", $name, $description, $price, $duration, $image_name, $is_available);

        if (mysqli_stmt_execute($stmt)) {
            $_SESSION['message'] = "Spa service added successfully";
...
<head>
    ...
    <title>Add New Spa Service - Lakeside Resorts</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="spa_add.php" method="post" enctype="multipart/form-data">
